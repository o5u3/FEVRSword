--[[---------Hats Supported---------]]--
-- Galaxy Sword: https://roblox.com/catalog/5355685721/
-- Russo's Sword: https://roblox.com/catalog/5909776064/
-- Any Greatsword (Example): https://roblox.com/catalog/4506945409/
--[[--------------------------------]]--
...
game:GetService("RunService").RenderStepped:Connect(function()
    setsimulationradius(math.huge) -- net
end)

local character1 = game.Players.LocalPlayer.Character
local sword = nil
local rArm1 = character1["Right Arm"]
local lArm1 = character1["Left Arm"]
...
userInputService.InputBegan:Connect(function(key)
    --No VR-------------------------------------------------------------------------------
    if key.KeyCode == Enum.KeyCode.F and not vrService.VREnabled then
...
--Netword Bypass (Given to me by a friend)------------------------------------------------
spawn(function()
    while true do
